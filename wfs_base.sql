...
--
-- Хост: localhost
-- Время создания: Сен 30 2016 г., 15:00
...
INSERT INTO `divisions` (`ID`, `PARENT_ID`, `TITLE_SHORT`, `TITLE_FULL`, `SORT_ID`, `IS_DEPARTMENT`, `is_leaf`, `PATH`) VALUES
(1, 0, 'МРСК С-З ИА', 'ПАО "МРСК Северо-Запада" Исполнительный Аппарат', 0, 1, '0', '/1/'),
(2, 1, 'филиал «Колэнерго»', 'филиал "Колэнерго" ПАО "МРСК Северо-Запада" ', 4, 1, '0', '/1/2/'),
(4, 2, 'ПО СЭС ', 'ПО "Северные Электрические Сети"  филиала "Колэнерго" ПАО "МРСК Северо-Запада"', 0, 0, '1', '/1/2/4/'),
(5, 2, 'ПО ЦЭС', 'ПО "Центральные Электрические Сети"  филиала "Колэнерго" ПАО "МРСК Северо-Запада"', 0, 0, '1', '/1/2/5/'),
...
(1, 1, 'Воронов', 'Сергей', 'Александрович', 'savoronov@kolenergo.ru', 'kolu0897', 'qwerty', 1, 1, 1),
(2, 1, 'Гончаров', 'Игорь', 'Вячеславович', 'igoncharov@kolenergo.ru', '', 'qwerty', 1, 1, 1),
(3, 8, 'Герасим', 'Владислав', 'Янович', 'vygerasim@kolenergo.ru', 'kolu0325', 'qwerty', 0, 0, 0);
...
--
ALTER TABLE `attachments`
  MODIFY `ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Идентификатор файла', AUTO_INCREMENT=105;
--
-- AUTO_INCREMENT для таблицы `divisions`
--
ALTER TABLE `divisions`
  MODIFY `ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Уникальный ключ', AUTO_INCREMENT=147;
--
...
--
ALTER TABLE `violations`
  MODIFY `ID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Идентификатор события', AUTO_INCREMENT=198;
